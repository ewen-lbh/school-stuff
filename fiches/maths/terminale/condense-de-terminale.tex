...
Ensemble des imaginaires purs: $i\R := \mathds{C} \setminus \R$
...
\begin{itemize}
    \item $\re z = 0 \iff z \in i\R$
    \item $\im z = 0 \iff z \in \R$
\end{itemize}
...
\begin{itemize}
    \item $\forall C \in \R\quad x \mapsto F(x) + C$ est une primitive de $f$
