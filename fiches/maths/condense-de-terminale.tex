...
%TODO: les propriétés sont applicables seulement à N(0, 1) ou à toutes les lois normales? Si seulement à N(0, 1), il faut que ce soit dans la section 2.13.1.
\begin{align*}
...
%TODO: théorème Moivre-Laplace (pas de demo)
%TODO: N(\mu, \sigma^2)
...
\subsection{Propriétés}
%TODO: définir les variables (P, d, d', etc)
\begin{equation*}
    \begin{split}
...
%TODO: plan caractérisé par 2 vecteurs non colin. et un point
%TODO: décomposition d'un vecteur en fonction de trois vecteurs non coplanaires
...
% - déterminéer une équation cartésienne d'un plan connaissant un point et un vecteur normal
