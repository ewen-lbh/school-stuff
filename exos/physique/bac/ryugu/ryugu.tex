...
\section{Propulsion de la sonde Hayabusa 2}
\subsection{}
\emph{Sur sujet} 
...
\subsubsection{}
\begin{align*}
	\underset{A\to B}{W\vec E} &= qE \\
	&=  \\
\end{align*}

\section{Photographie de l'astéroïde Ryugu et transmission des données}
\subsection{}
\[
	\frac{1100}{512} &= \SI{2.14}{\meter}
\] 

\subsection{}
\emph{On mesure à la règle} 
